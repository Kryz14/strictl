    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type='Number' placeholder='35,000.00' />
        </div>
      </div>
      ...
      <button type='submit' className='w-28 py-3 ml-4 bg-black text-white'> ADD</button>
    </form>
  )
}
